...
def predict_earthquake_events(lat, lon, depth, year, month, hour, nb_station, time_since_last_eq):
    ...
    features_reg = [[lat, lon, depth, year, month, hour, nb_station, time_since_last_eq]] 
    ...
    features_clf = [[lat, lon, depth, pred_magnitude, year, month, hour, time_since_last_eq]]
    if model_tsunami:
